...
// e, desde o C6, para a comparação idempotente do `encha-guard` —
// ContainerSpec.Env/Healthcheck/Capability* e TaskTemplate.Networks foram
// acrescentados aqui, tipados, em vez de cair no índice `[k: string]:
// unknown` que já existia — ver src/lib/guard-runtime.ts).
